...
public:
    ...
    void add_query_field(QString fieldname, int size, QString sql_field,
                         int alignment = 0);
    ...
    QVector<int>
        header_show_flag; ///< вектор флагов показвать/не показвать поле
...
class Defichit2RenameDialog
    : public QDialog
    , public Ui::Defichit2RenameDialog
{
    Q_OBJECT
public:
    Defichit2RenameDialog(QWidget *parent = 0, const QString &name = QString(),
                          int type = 0, const QString &kompl = QString());
